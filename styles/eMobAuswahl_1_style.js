var size = 0;
var placement = 'point';
function categories_eMobAuswahl_1(feature, value, size, resolution, labelText,
...
case 'teilweise belegt':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 8.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(247,225,55,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1}), fill: new ol.style.Fill({color: 'rgba(250,255,57,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_eMobAuswahl_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_eMobAuswahl_1(feature, value, size, resolution, labelText,
